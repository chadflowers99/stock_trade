...
def auth_ui():
    ...
    # Constrain auth form width
    st.markdown(
        """
        <style>
        [data-testid="stVerticalBlock"] > [data-testid="column"]:first-child { width: 0% !important; }
        [data-testid="stVerticalBlock"] > [data-testid="column"]:last-child { width: 0% !important; }
        </style>
        """,
        unsafe_allow_html=True,
    )
