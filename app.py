...
st.markdown(
    ...
    <div style='padding: 0.25rem 0 0.55rem 0; border-bottom: 2px solid rgba(46, 204, 113, 0.25);'>
        <h1 style='margin: 0; line-height: 1.05; letter-spacing: 0.015em; font-weight: 800;'><span style='color: #2ecc71; font-family: "Segoe UI", sans-serif; font-size: 3.0rem;'>PORTFOLIO</span><span style='color: #000000; display: inline-block; transform: translateY(0.14em); margin-left: 0.08em; font-family: "Segoe UI", sans-serif; font-size: 1.8rem;'>brand.</span></h1>
